...
- گزینه حذف بره زیرمجموعه دکمه ویرایش قرار بگیره
- بخش تعریف و ویرایش منبع هم کاملا دستی بشه مثل روال قبل
- وقتی کارمند /resource زده میشه یه پیام نشون داده بشه با گزینه ذره بین جهت باز کردن اینلاین کوئری منابع و یکی جهت افزودن منبع جدید، وقتی منبعی انتخاب شد جزئیاتش با قابلیت های قبل دیده بشه، گزینه بازگشت فراموش نشه
- قابلیت جستجو و افزودن منبع به صورت دستی به هر فعالیت هم به شکل اینلاین کوئری باشه
- وقتی روی دکمه ویرایش توضیحات زده میشه یه دکمه اضافه بشه برای گفتگو با هوش مصنوعی تا در مورد جزئیات و توضیحات در صورت نیاز با مدل زبانی مشورت بشه و در نهایت در صورت تمایل محتوای توضیحات توسط مدل آپدیت بشه
- ویرایش تکرار فعالیت توسط مدل زبانی انجام بشه نه دستی